...
const translations: Record<string, string> = {
  ...
  "Gateway 未配置 System Update 信任公钥": "Gateway has no System Update trust key",
  ...
  "Gateway 会先验签并保存原始包，再保全 Core Dump、进入 Recovery、提交更新，最后校验新固件与实际 Flash 清单。": "The Gateway verifies and archives the bundle, preserves the core dump, enters Recovery, commits the update, then validates the new firmware and actual Flash inventory.",
